<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vSeleccionCliente.aspx.cs" Inherits="PedidoSugeridoLamosa.Usuario.vSeleccionCliente" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function btnAceptar_onclick()
        {
            ...
            window.parent.btnAceptarDialogCliente_onclick(id_cliente, nom_cliente, desc_comp);
        }
        
        function window_onload()
        {
            var id_cliente = window.parent.document.getElementById("ctl00_Principal_UltraWebGrid1_ctl00_txtIdcliente").value;
            var nom_cliente = window.parent.document.getElementById("ctl00_Principal_UltraWebGrid1_ctl00_txtClienteDesc").value;
            var desc_comp = window.parent.document.getElementById("ctl00_Principal_UltraWebGrid1_ctl00_txtCompDesc").value;
