...
var ttBgColor     = "";
var ttBgImg = "../Imagenes/help.gif";   ///"ToolTip/help.gif" 
...
{
	if (ShowHelp==false) {
	    window.document.getElementById("imgHelp").src = "../Imagenes/information_.jpg";
		ShowHelp=true;
	}
	else {
	    window.document.getElementById("imgHelp").src ="../Imagenes/information2_.jpg";
		ShowHelp=false;
	}
}
...
function tt_Htm(tt, t_id, txt)
{
	...
	{
		txt="<TABLE width=390 border=0 ><TR> <TD height=22></TD> <TD></TD> </TR> <TR> <TD height=150></TD> <TD valign=top class=ms-descriptiontextToolTip>" + txt + "</TD> </TR> </TABLE>" ;
	}
	else
	{
		var hImg="0";
		...
		txt="<TABLE width=200 border=0 bgColor=" + t_bgc + " ><TR> <TD height=" + hHeadImg + "></TD> <TD></TD> </TR> <TR> <TD height=" + hImg + "></TD> <TD valign=top class=ms-descriptiontextToolTip>" + txt + "</TD> </TR> </TABLE>" ;
	}
