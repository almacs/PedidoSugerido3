...
var ttBgColor     = "";
var ttBgImg       = "../ToolTip/help.gif";           // path to background image;
...
function help_onclick()
{
	if (ShowHelp==false)
	{
		window.document.all["imgHelp"].src="../ToolTip/information_.jpg";
		ShowHelp=true;
	}
	else
	{
		window.document.all["imgHelp"].src="../ToolTip/information2_.jpg";
		ShowHelp=false;
	}
}
