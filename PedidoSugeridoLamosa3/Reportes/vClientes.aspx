<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vClientes.aspx.cs" Inherits="PedidoSugeridoLamosa.Reportes.vClientes" %>
...
<body style="margin:0px; width:100%;">
    ...
    <div style="width:100%">
        <table width="100%">
                            ...
                            <tr>
                                <td class="textos_01">
                                    Id Cliente de : <asp:TextBox ID="txtIdClienteD" runat="server" Width="130px" MaxLength="20" /> a <asp:TextBox ID="txtIdClienteA" runat="server" Width="130px" MaxLength="20" /> <a href="#" onclick="return lnkBuscar_onclick();" >Buscar</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="textos_01">
