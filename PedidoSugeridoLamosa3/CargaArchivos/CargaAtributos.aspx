<%@ Page Language="C#" MasterPageFile="~/PedidoSugeridoLamosa.Master" AutoEventWireup="true" CodeBehind="CargaAtributos.aspx.cs" Inherits="PedidoSugeridoLamosa.CargaArchivos.CargaInventario" Title="Carga de Atributos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Principal" runat="server">
    ...
    <table align="center" width="100%"  border="0" cellpadding="0" cellspacing="0" style="background-color:white; height:450px;" >
            ...
            <tr style=" height:30px;">
                ...
                <td colspan= "2" style=" width:1014px;"  class ="lblTitulo1" onmouseover="this.T_DESCPANTALLA=true; this.T_BGIMG='../Imagenes/help2.gif'; this.T_HEIGHT=200; this.T_WIDTH=400; this.T_ABOVE=false; this.T_CLICKCLOSE=true; this.T_STICKY=true; return escape('<b>Carga de Datos</b> <p></p>La sección Carga Datos le permite actualizar de manera rápida mediante la carga de un archivo de Excel,  los atributos (Inventario Mínimo, Máximo y Pedido Mínimo) de cada uno de los artículos seleccionados. También, mediante la carga de otro archivo, usted puede actualizar el inventario real existente de dichos artículos de manera periódica.');">
                    <asp:Label ID="lblTitulo" runat="server" Text="Carga de Atributos de Artículos" ></asp:Label><br/>
                </td> 
            ...
            <tr>
                <td colspan = "3">
                     <table align= "center"  border="0" cellpadding="0" cellspacing="0" 
                        ...
                        <tr>
                            ...
                            <td style="height:30px; width: 159px;">
                                <input  id="File1" type= "hidden" class="Boton_01" title="Examinar" value="Examinar" style="width: 103px" />
                        ...
                        <tr>
                            ...
                            <td style="height:30px; width: 159px;" align= "right">
                                <asp:Button ID="CargaButton" CssClass="Boton_01" Text="Cargar" runat="server" OnClick="CargaButton_Click" Width="83px" />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div style="visibility:hidden; display:none;">
                        <asp:Button ID="btn_Log" runat="server" onclick="btn_Log_Click" Text="Log" CssClass="hidden" />
        ...
        <asp:Literal ID="id_mensaje" runat="server"></asp:Literal>
    </table>
